...
**작성 사유**: 2026-05-04 routine이 09시 일일 브리핑에서 결정한 "T3 1건만 발행"을 무시하고 12/15/18시 슬롯에서 모두 발행하는 사고 발생. 슬롯 검증 게이트 강화.
...
| Phase 2 | 2026-05-11 ~ 2026-05-26 | 1건 | 주 2건 한정 | 금지 | 1건/주 한정 |
| Phase 3 | 2026-05-27 ~ | 1건 | ≤30% | 단일만 (N/M 영구 금지) | 정상 |

> 일일 발행 상한은 모든 Phase에서 1건/일로 고정 (2026-05-10 결정). Phase 구분은 외부 링크·실험 정책에만 적용.
