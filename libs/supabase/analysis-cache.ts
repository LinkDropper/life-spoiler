...
import type { FortuneInterpretation, InterpretationType } from "@/libs/services/ai";

import { createServerClient } from "./client";
import type { AnalysisResultInsert, AnalysisResultRow, Database } from "./types";
...
export const generateChartHash = (params: {
  ...
  const { birthDate, birthTime, gender, calendarType, isLeapMonth = false } = params;
